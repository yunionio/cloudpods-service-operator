...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IntOrStringOrYaml) DeepCopyInto(out *IntOrStringOrYaml) {
	*out = *in
	out.IntOrString = in.IntOrString
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IntOrStringOrYaml.
func (in *IntOrStringOrYaml) DeepCopy() *IntOrStringOrYaml {
	if in == nil {
		return nil
	}
	out := new(IntOrStringOrYaml)
