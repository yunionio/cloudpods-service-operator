...
func (in *AnsiblePlaybookHost) DeepCopyInto(out *AnsiblePlaybookHost) {
	*out = *in
	...
	if in.Vars != nil {
		...
		*out = make(map[string]IntOrStringValue, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IntOrStringValue) DeepCopyInto(out *IntOrStringValue) {
	*out = *in
	if in.Direct != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IntOrStringValue.
func (in *IntOrStringValue) DeepCopy() *IntOrStringValue {
	if in == nil {
		return nil
	}
	out := new(IntOrStringValue)
	in.DeepCopyInto(out)
	return out
}
